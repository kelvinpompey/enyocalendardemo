...
enyo.path.addPaths({layout: "/Users/kelvin/calendar/enyo/../lib/layout/", onyx: "/Users/kelvin/calendar/enyo/../lib/onyx/", onyx: "/Users/kelvin/calendar/enyo/../lib/onyx/source/"});
...
leave: function(e, t) {
return this.removeClass("selected"), !0;
}
});
...
var r = moment(e).add("days", n);
return t.$.week.createComponent({
content: moment(r).format("ddd Do MMM"),
classes: "day"
}), r;
}), _.range(8).map(function(e) {
_.each(t.week, function(e) {
t.appointments.push(_.random(1));
});
}), _.each(this.appointments, function(e, n) {
t.$.grid.createComponent({
kind: "GridCell",
index: n,
content: e === 1 ? "YES" : ""
});
...
setupList: function(e, t) {
var n = this.hours[t.index];
this.$.listItem.setContent(n);
},
updateGridAtIndices: function(e) {
var t = this;
_.each(e, function(e) {
